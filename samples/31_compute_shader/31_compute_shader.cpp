...
private:
    ...
    void createGraphicsPipeline() {
        auto vertShaderCode = readFile("shaders/31_shader_compute.vert.spv");
        auto fragShaderCode = readFile("shaders/31_shader_compute.frag.spv");
    ...
    void createComputePipeline() {
        auto computeShaderCode = readFile("shaders/31_shader_compute.comp.spv");
